...
${a}
${o}`)}function Td(e){return e.replace(/(^|\n)•( +)/g,"$1*$2")}function _u(e){return vd.makeHtml(Ed(Td(e)))}function yu(e){if(e.nodeName==="IFRAME"){let t=e.ownerDocument.createTextNode(e.src);e.parentNode.replaceChild(t,e)}}var wu=B(Z(),1);function sn(e){!e.id||e.id.indexOf("docs-internal-guid-")!==0||(e.tagName==="B"?(0,wu.unwrap)(e):e.removeAttribute("id"))}function Cd(e){return e===" "||e==="\r"||e===`
